// src/components/IrisSidebar.tsx
// Unified sidebar — combines conversation management (left panel) with
// the NerveSparks brand/model info (right panel) into one component.
    ...
    Alert.alert(conv.title, 'Choose an action', [
      ...
      },
      {
        ...
        onPress: () => {
          ...
          Alert.alert('Move to Folder', 'Select a folder:', opts);
        },
      },
      {
        text: '🗑 Delete',
      ...
      <View style={styles.drawer}>
        ...
        >
          ...
          <View style={styles.modelBadge}>
            ...
            <Text style={styles.modelValue} numberOfLines={1}>{activeModelName}</Text>
          </View>
        </LinearGradient>
        ...
        <View style={styles.footer}>
          ...
          >
            <Text style={styles.footerBtnText}>Star us</Text>
            <Image source={require('../assets/icons/github.png')} style={styles.githubIcon} />
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.footerBtn}
            onPress={() => Linking.openURL('https://nervesparks.com')}
          >
            <Text style={styles.footerBtnText}>NerveSparks.com</Text>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  // Header — brand
  header: {
    paddingTop: StatusBar.currentHeight ? StatusBar.currentHeight + 14 : 48,
  ...
  logoImage: { width: 34, height: 34, borderRadius: 17, marginRight: 12 },
  brandTitle: { color: '#ffffff', fontSize: 22, fontWeight: '700' },
  brandSubtitle: { color: '#64748b', fontSize: 12 },
  modelBadge: {
    backgroundColor: 'rgba(255,255,255,0.05)',
    borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8,
    borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)',
  },
  modelLabel: { color: '#64748b', fontSize: 11, marginBottom: 2 },
  modelValue: { color: '#e2e8f0', fontSize: 13, fontWeight: '600' },
  ...
  sectionLabel: { color: '#4a5568', fontSize: 10, fontWeight: '700', letterSpacing: 1.2 },
  addFolderBtn: {
  ...
  listSectionLabel: {
    ...
    paddingHorizontal: 16, paddingTop: 10, paddingBottom: 4, textTransform: 'uppercase',
  },
